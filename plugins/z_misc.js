...
AMDI({ cmd: "cueerrrency", desc: Lang.currencyDesc, example: Lang.currencyEx, type: "primary", react: "💱" }, (async (amdiWA) => {
...
AMDI({ cmd: "imgekd2url", desc: Lang.img2urlDesc, type: "primary", react: "🔗" }, (async (amdiWA) => {
...
AMDI({ cmd: "removebg", desc: Lang.REMOVEBG_DESC, type: "primary", react: "✂️" }, (async (amdiWA) => {
    ...
    await sendDocument(fs.readFileSync('rbg.png'), { quoted: true, fileName: 'GodLiuShen.png', mimetype: 'image/png' })
    await react("✔️");
...
AMDI({ cmd: "okcks", desc: "Scarp tk info", react: "💃🏻", type: "primary" }, (async (amdiWA) => {
...
AMDI({ cmd: "scripkskt", desc: "Queen Amdi deploy site info", react: "💃🏻", type: "primary" }, (async (amdiWA) => {
