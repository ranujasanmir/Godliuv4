...
AMDI({ cmd: "tagwa", desc: "Tag official whatsapp.", type: "primary", react: "🧚‍♂️" }, (async (amdiWA) => {
...
AMDI({ cmd: "owner", cmdHideInMenu: true, type: "primary" }, (async (amdiWA) => {
    let { sendText } = amdiWA.msgLayout;
    return await sendText(`Owner Number : @94726809382`, { mentionJIDS: ['94726809382@s.whatsapp.net'], quoted: true, reactEmoji: "✅" });
}));
